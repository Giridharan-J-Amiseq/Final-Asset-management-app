/**
 * Assignment workflow page.
 *
 * Assigns an "Available" asset to an active user by calling
...
function GroupedSearchSelect({
  ...
  // Keeping it inline avoids over-engineering while still providing a
  // fast UX for large lists.
    ...
    api
      ...
      .then((response) => {
        ...
        if (asset.asset_status !== "Available") {
          setError("This asset is not available for assignment.");
